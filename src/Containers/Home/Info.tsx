...
const Info =({pizza1,pizza2}:InfoType)=>{
  return(
    <section className="flex w-full h-[40vh]">
        ...
        <div className="flex h-full w-[50%] justify-evenly items-center 
        transition delay-1000 ease-linear duration-700 " id="test">
          <img src={image.Pizza} alt="pizza" ref={pizza1} className="h-[195px] pizza1 relative" />
          <img src={image.Pizza} alt="pizza" ref={pizza2} className="h-[195px] pizza2 relative" />
