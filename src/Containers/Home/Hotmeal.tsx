...
const HotMeal = ({ navigate, menu1, menu2 }: hotMealType) => {
  return (
    <section className="h-[115vh] text-white flex flex-col items-center bg-black justify-center">
      ...
      <div ref={menu1} className="flex w-[80%] justify-evenly h-[30%] relative order" >
        {
      ...
      <div ref={menu2} className="flex w-[80%] justify-evenly h-[30%] relative order">
        {
      ...
      <div>
        <section className="w-[120px] h-[40px] bg-[#ff6240] flex justify-center 
