    ...
    <>
      <section>
        <video
          ...
          loop
          muted
          className="h-[85vh] w-full object-cover opacity-30"
        >
      ...
      <section
        ref={title}
        className="w-[80%] h-[55vh] flex flex-col justify-around items-center
      ...
      >
        <div className="flex flex-col  items-center h-[70%] w-full">
          ...
          <p className="uppercase text-[50px] font-bold">
            {welcomeMessage.subTitle}
          </p>
          <p className="text-[28px] w-[60%] text-center">
            {welcomeMessage.describion}
          </p>
        </div>
        <div className="flex w-[40%] justify-evenly h-[10%] items-center">
          <CustomButton
            btnName="Read Blog"
            style="bg-[#fac564] transition delay-150 duration-300 ease-in-out\
